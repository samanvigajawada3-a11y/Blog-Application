...
export const navContainerClass = "max-w-5xl mx-auto w-full flex items-center justify-end";
...
export const navLinkClass = "text-[0.8rem] text-[#6e6e73] hover:text-[#1d1d1f] transition-colors font-normal shadow rounded-2xl p-2";
export const navLinkActiveClass = "text-[0.8rem] text-[#0066cc] font-medium bg-cyan-100 rounded-2xl p-2";
